...
import (
	...
	"github.com/stevenlee87/go-gin-example/service/article_service"
	"github.com/stevenlee87/go-gin-example/service/tag_service"
)
...
func GetArticles(c *gin.Context) {
	...
	data["lists"] = articles
	// fmt.Print("data[lists] is:", articles) ,articles 是一个obj g.C.JSON接收的参数就是对象
	data["total"] = total
